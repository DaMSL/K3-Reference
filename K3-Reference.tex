...
%
    ...
    \begin{description}
        ...
        \item[By Return:] If the result of an expression is the return value of a generated
            ...
            returned directly.
            \sn{Unless of course the expression requires that the result be stored in an intermediate.
            (e.g.~$\gtSome$, $\gtInd$), in which case, how does allocation work in the return context?}
